      ...
      ? (
        ...
        (
          <div className="messageContainer" style={{display: 'flex', justifyContent: 'flex-end', borderRadius: '2rem', paddingRight: '2rem', margin: '1rem', width: '55%', float: 'right'}}>
            ...
            {user !== 'admin' && <img src={user.profile.picture} alt={user.profile.name} style={{borderRadius: '50%', height: '2.5rem', width: '2.5rem', marginTop: '.6rem', marginRight: '-1.5rem', marginLeft: '1rem'}}/>}
